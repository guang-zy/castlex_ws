...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.size = 1;
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TutorialsConfig::AbstractParamDescriptionConstPtr(new TutorialsConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 13, 'description': 'A small constant', 'srcfile': '/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Small'}, {'srcline': 14, 'description': 'A medium constant', 'srcfile': '/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Medium'}, {'srcline': 15, 'description': 'A large constant', 'srcfile': '/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Large'}, {'srcline': 16, 'description': 'An extra large constant', 'srcfile': '/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'ExtraLarge'}]}", &TutorialsConfig::size)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(TutorialsConfig::AbstractParamDescriptionConstPtr(new TutorialsConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 13, 'description': 'A small constant', 'srcfile': '/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Small'}, {'srcline': 14, 'description': 'A medium constant', 'srcfile': '/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Medium'}, {'srcline': 15, 'description': 'A large constant', 'srcfile': '/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Large'}, {'srcline': 16, 'description': 'An extra large constant', 'srcfile': '/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'ExtraLarge'}]}", &TutorialsConfig::size)));
...
//#line 13 "/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg"
      const int Tutorials_Small = 0;
//#line 14 "/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg"
      const int Tutorials_Medium = 1;
//#line 15 "/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg"
      const int Tutorials_Large = 2;
//#line 16 "/home/zy/catkin_ws/src/ros_advanced/dynamic_tutorials/cfg/Tutorials.cfg"
